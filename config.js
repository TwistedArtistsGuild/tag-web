...
const config = {
  // REQUIRED
  appName: "Twisted Artists Guild",
  // REQUIRED (no https://, not trialing slash at the end, just the naked domain)
  domainName: "twistedartistsguild.com",
  crisp: {
  ...
  mailgun: {
    ...
    subdomain: "lc.twistedartistsguild.com",
    // REQUIRED — Email 'From' field to be used when sending magic login links
    fromNoReply: `TAG <noreply@twistedartistsguild.com>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
    fromAdmin: `TAG Admin <admin@twistedartistsguild.com>`,
    // Email shown to customer if need support. Leave empty if not needed => if empty, set up Crisp above, otherwise you won't be able to offer customer support."
    supportEmail: "admin@twistedartistsguild.com",
    // When someone replies to supportEmail sent by the app, forward it to the email below (otherwise it's lost). If you set supportEmail to empty, this will be ignored.
    forwardRepliesTo: "admin@twistedartistsguild.com",
  },
  colors: {
