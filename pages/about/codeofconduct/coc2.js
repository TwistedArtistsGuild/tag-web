...
export default function CodeOfConduct({ content }) {
	return (
      ...
      <TagSEO metadataProp={{ title: "Github Projects Tag Tag Web Pages About Codeofconduct Coc2 | Twisted Artists Guild", description: "Explore Github Projects Tag Tag Web Pages About Codeofconduct Coc2 on Twisted Artists Guild.", keywords: "artists, art community, marketplace", og: { title: "Github Projects Tag Tag Web Pages About Codeofconduct Coc2 | Twisted Artists Guild", description: "Explore Github Projects Tag Tag Web Pages About Codeofconduct Coc2 on Twisted Artists Guild." } }} canonicalSlug="/github_projects/tag/tag-web/pages/about/codeofconduct/coc2" />
			<Head>
...
export async function getStaticProps() {
	const content = await getMarkdownContent("content/coc2.md")
	return {
		props: {
			content,
		},
