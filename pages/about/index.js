...
export default function About() {
	...
	return (
		<div className="flex flex-col justify-start items-center min-h-screen w-full py-12 px-4 relative overflow-hidden">
			...
			<div className="max-w-5xl mx-auto">
				...
				<section id="about" className="mb-16">
					<div className="relative text-center">
						...
						<h2 className="text-4xl md:text-5xl font-bold relative z-10 mb-3 text-primary-content">
							About the <span className="text-primary">Twisted Artists&apos; Guild</span>
						</h2>
