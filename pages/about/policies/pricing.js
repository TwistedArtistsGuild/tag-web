...
export default function CodeOfConduct({ content }) {
	return (
      ...
      <TagSEO metadataProp={{ title: "Github Projects Tag Tag Web Pages About Policies Pricing | Twisted Artists Guild", description: "Explore Github Projects Tag Tag Web Pages About Policies Pricing on Twisted Artists Guild.", keywords: "artists, art community, marketplace", og: { title: "Github Projects Tag Tag Web Pages About Policies Pricing | Twisted Artists Guild", description: "Explore Github Projects Tag Tag Web Pages About Policies Pricing on Twisted Artists Guild." } }} canonicalSlug="/github_projects/tag/tag-web/pages/about/policies/pricing" />
			<Head>
				<title>TAG Code of Conduct - Artist Members</title>
...
export async function getStaticProps() {
	const content = await getMarkdownContent("content/policy_pricing.md")
	return {
		props: {
			content,
		},
