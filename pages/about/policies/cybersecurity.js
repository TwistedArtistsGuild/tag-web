...
export default function CodeOfConduct({ content }) {
	return (
      ...
      <TagSEO metadataProp={{ title: "Github Projects Tag Tag Web Pages About Policies Cybersecurity | Twisted Artists Guild", description: "Explore Github Projects Tag Tag Web Pages About Policies Cybersecurity on Twisted Artists Guild.", keywords: "artists, art community, marketplace", og: { title: "Github Projects Tag Tag Web Pages About Policies Cybersecurity | Twisted Artists Guild", description: "Explore Github Projects Tag Tag Web Pages About Policies Cybersecurity on Twisted Artists Guild." } }} canonicalSlug="/github_projects/tag/tag-web/pages/about/policies/cybersecurity" />
			<Head>
...
export async function getStaticProps() {
	const content = await getMarkdownContent("content/policy_cybersecurity.md")
	return {
		props: {
			content,
		},
