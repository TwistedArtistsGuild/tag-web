...
export default function CodeOfConduct({ content }) {
	return (
      ...
      <TagSEO metadataProp={{ title: "Github Projects Tag Tag Web Pages About Policies Refunds | Twisted Artists Guild", description: "Explore Github Projects Tag Tag Web Pages About Policies Refunds on Twisted Artists Guild.", keywords: "artists, art community, marketplace", og: { title: "Github Projects Tag Tag Web Pages About Policies Refunds | Twisted Artists Guild", description: "Explore Github Projects Tag Tag Web Pages About Policies Refunds on Twisted Artists Guild." } }} canonicalSlug="/github_projects/tag/tag-web/pages/about/policies/refunds" />
			<Head>
				<title>TAG Code of Conduct</title>
...
export async function getStaticProps() {
	const content = await getMarkdownContent("content/policy_refunds.md")
	return {
		props: {
			content,
		},
