...
export default function CodeOfConduct({ content }) {
	return (
      ...
      <TagSEO metadataProp={{ title: "Github Projects Tag Tag Web Pages About Policies Copyrights | Twisted Artists Guild", description: "Explore Github Projects Tag Tag Web Pages About Policies Copyrights on Twisted Artists Guild.", keywords: "artists, art community, marketplace", og: { title: "Github Projects Tag Tag Web Pages About Policies Copyrights | Twisted Artists Guild", description: "Explore Github Projects Tag Tag Web Pages About Policies Copyrights on Twisted Artists Guild." } }} canonicalSlug="/github_projects/tag/tag-web/pages/about/policies/copyrights" />
			<Head>
