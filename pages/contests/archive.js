...
export default function VoteArchive() {
	return (
      <div className="min-h-screen bg-linear-to-b from-base-200 to-base-300 py-10 px-4">
			<TagSEO metadataProp={{ title: "Contest Archive", description: "Browse past contests, winners, and top entries.", keywords: "contests, archive, artists", og: { title: "Contest Archive", description: "Browse past contests, winners, and top entries." } }} canonicalSlug="contests/archive" />
