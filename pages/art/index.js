...
const generateFakeListings = () => {
    return [
        // Sculpture Category
        {
            ...
            description: 'Hand-crafted bronze dragon sculpture with incredible detail. Perfect centerpiece for fantasy enthusiasts.',
            price: 1299.99,
            path: 'bronze-dragon',
        ...
        },
        {
            ...
            description: 'Eco-friendly sculpture made from reclaimed metal parts. This majestic eagle has a wingspan of 24 inches.',
            price: 450.00,
            path: 'recycled-eagle',
            created: new Date().toISOString(),
            artist: {
        ...
        },
        {
            ...
            description: 'Oil painting inspired by classic Impressionist techniques. This garden scene bursts with color and light.',
            price: 675.00,
        ...
        // Photography Category
        {
            ...
            description: 'Limited edition print series documenting wildlife in unexpected urban environments. Signed by the artist.',
            price: 275.00,
            path: 'urban-wildlife',
            created: new Date().toISOString(),
            artist: {
        ...
        // Crochet Category
        {
            ...
            description: 'Luxurious handmade crochet blanket with intricate pattern. Made with 100% merino wool in beautiful earth tones.',
            price: 189.99,
        ...
        // Digital Services Category
        {
            ...
            description: 'Professional website development services tailored to artists and creative businesses. Includes responsive design and SEO optimization.',
            price: 1499.00,
        ...
        },
        {
            ...
            description: 'Custom digital portfolio design to showcase your artwork with striking presentation. Includes up to 10 gallery pages.',
            price: 650.00,
        ...
        },
        {
            ...
            description: 'Complete setup of your online art store with payment processing, inventory management, and beautiful product displays.',
            price: 1250.00,
        ...
        // Performance Art Category
        {
            ...
            description: 'Book our aerial silk performers for your next event. Stunning choreography that will leave your guests speechless.',
            price: 850.00,
            path: 'aerial-silk',
            created: new Date().toISOString(),
            artist: {
        ...
        },
        {
            ...
            description: 'Mesmerizing fire dancing performance featuring skilled artists with poi, staff, and hoop. Perfect for evening events.',
            price: 750.00,
            path: 'fire-dancing',
            created: new Date().toISOString(),
            artist: {
        ...
        },
        {
            ...
            description: 'Immersive theater performance where audience members become part of the story. Custom themes available.',
            price: 1200.00,
