...
const ShareholderVote = () => {
  ...
  return (
      <div className="min-h-screen bg-linear-to-b from-base-200 to-base-300 p-8 flex flex-col items-center">
  			<TagSEO metadataProp={{ title: "Shareholder Vote", description: "Cast your shareholder vote for the current proposal.", keywords: "shareholder, vote, governance", og: { title: "Shareholder Vote", description: "Cast your shareholder vote for the current proposal." } }} canonicalSlug="shareholders/shareholder_vote" />
