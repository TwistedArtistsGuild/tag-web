...
import SocialComments from "@/components/SocialComments"; // Import SocialComments component
                ...
                <div className="card shadow-lg p-4 bg-base-100">
                    <div className="flex flex-col md:flex-row gap-6">
                        <div className="md:w-1/2">
                            <h1 className="text-3xl font-bold mb-4">{listing.title || "Untitled"}</h1>
                            ...
                            <p className="text-lg mb-6"><strong>Description:</strong> {listing.description || "No description available"}</p>
                        </div>
                        <div className="md:w-1/2">
                            {/* Image Gallery */}
                            <div className="rounded-lg overflow-hidden shadow-md" style={{ maxHeight: '600px' }}>
                                <ImageGallery 
                                    items={sampleImages}
                                    showPlayButton={true}
                    ...
                    <div className="overflow-x-auto mt-8">
                        <h2 className="text-xl font-bold mb-4 border-b pb-2">Artwork Details</h2>
                        <table className="table w-full border border-base-300">
                            <tbody>
                                ...
                                <tr className="hover:bg-base-200">
                                    ...
                                    <td className="bg-base-100 text-base-content">{listing.price !== null ? `$${listing.price}` : "N/A"}</td>
                                    <th className="bg-base-100 text-base-content font-medium">Created</th>
                                    <td className="bg-base-100 text-base-content">{listing.created ? new Date(listing.created).toLocaleDateString("en-US") : "N/A"}</td>
                                </tr>
                                <tr className="hover:bg-base-200">
                    ...
                    <div className="mt-8">
                        <h2 className="text-xl font-bold mb-4 border-b pb-2">Comments & Feedback</h2>
                        <SocialComments 
                            initialComments={sampleComments}
                            onAddComment={handleAddComment}
                            onUpdateComment={handleUpdateComment}
                            onLikeComment={handleLikeComment}
                            contextId={`listing-${listing.listingID}`} // Using the listing ID as context
...
ListingDetails.getInitialProps = async function (context) {
